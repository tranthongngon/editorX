...
(function($){
    ...
    TTN.header = {
        ...
        init: function(){
            TTN.header.ajaxSearch();
            TTN.header.ttnSearchButton();
            TTN.header.offCanvasMenu();
            TTN.header.priorityNavInit();
            TTN.header.searchToggle();
            TTN.header.smartAffix.init({
        ...
        offCanvasMenu: function() {
            var $backdrop = $('<div class="ttn-offcanvas-backdrop"></div>');
            var $offCanvas = $('.js-ttn-offcanvas');
            var $offCanvasToggle = $('.js-ttn-offcanvas-toggle');
            var $offCanvasClose = $('.js-ttn-offcanvas-close');
            ...
            $(window).on('resize',function (e) {
                var checkExist = setInterval(function() {
                    var elementPC = $('#ttn-offcanvas-primary');
                    var elementMB = $('#ttn-offcanvas-mobile');
        ...
        smartAffix: {
            ...
            init : function init (options) {
                ...
                } else if ( !this.$fixedHeader.length || !this.$headerPlaceHolder.length || ( TTN.documentOnResize.windowWidth <= TTN.header.smartAffix.breakpoint ) ) { // Check if device width is smaller than breakpoint.
            ...
            compute: function compute(){
                if (TTN.header.smartAffix.isDestroyed || TTN.header.smartAffix.isDisabled) {
                    return;
                }
                ...
                // Set menu top offset
                this.windowScrollTop = TTN.documentOnScroll.windowScrollTop;
            ...
            */
            eventResize: function eventResize(windowWidth) {
                ...
                if ( TTN.documentOnResize.windowWidth < TTN.header.smartAffix.breakpoint ) {
                    this.isDisabled = true;
                } else {
                    this.isDisabled = false;
                    TTN.header.smartAffix.compute();
                }
            }
        },
    ...
    TTN.documentOnScroll = {
        ticking: false,
        windowScrollTop: 0, //used to store the scrollTop

        init: function() {
            window.addEventListener('scroll', function(e) {
                if (!TTN.documentOnScroll.ticking) {
                    window.requestAnimationFrame(function() {
                        TTN.documentOnScroll.windowScrollTop = $window.scrollTop();

                        // Functions to call here
                        if (!TTN.header.smartAffix.isDisabled && !TTN.header.smartAffix.isDestroyed) {
                            TTN.header.smartAffix.eventScroll(TTN.documentOnScroll.windowScrollTop);
                        }

                        TTN.documentOnScroll.goToTopScroll(TTN.documentOnScroll.windowScrollTop);

                        TTN.documentOnScroll.ticking = false;
                    });
                }
                TTN.documentOnScroll.ticking = true;
            });
        },
    ...
    TTN.documentOnResize = {
        ticking: false,
        windowWidth: $window.width(),

        init: function() {
            window.addEventListener('resize', function(e) {
                if (!TTN.documentOnResize.ticking) {
                    window.requestAnimationFrame(function() {
                        TTN.documentOnResize.windowWidth = $window.width();

                        // Functions to call here
                        if (!TTN.header.smartAffix.isDestroyed) {
                            TTN.header.smartAffix.eventResize(TTN.documentOnResize.windowWidth);
                        }

                        TTN.documentOnResize.ticking = false;
                    });
                }
                TTN.documentOnResize.ticking = true;
            });
        },
    };
    ...
    TTN.documentOnReady = {
        ...
        init: function(){
            TTN.header.init();
            TTN.header.smartAffix.compute();
            TTN.documentOnScroll.init();
            TTN.documentOnReady.goToTop();
            TTN.documentOnReady.circleMoveRandom();
            TTN.documentOnReady.carousel_1i();
            TTN.documentOnReady.carousel_1i30m();
            TTN.documentOnReady.carousel_1i30m_no_reponsive();
            TTN.documentOnReady.carousel_1i40m();
            TTN.documentOnReady.carousel_1i0m();
            TTN.documentOnReady.carousel_1i_get_src();
            TTN.documentOnReady.carousel_1i_get_src_multiple_margin();
            TTN.documentOnReady.carousel_1i_get_src_width_auto();
            TTN.documentOnReady.carousel_1i_get_src_width_auto_0m();
            TTN.documentOnReady.carousel_1i_get_src_width_auto_center();
            TTN.documentOnReady.carousel_hover_cursor_effect();
            TTN.documentOnReady.carousel_1i_text_fade();
            TTN.documentOnReady.carousel_1i_dot_number_effect();
            TTN.documentOnReady.carousel_2i30m();
            TTN.documentOnReady.carousel_3i0m();
            TTN.documentOnReady.carousel_4i0m();
            TTN.documentOnReady.carousel_auto_width();
            TTN.documentOnReady.carousel_auto_width_rtl();
            TTN.documentOnReady.carousel_auto_width_center();
            TTN.documentOnReady.carousel_auto_width_delay();
            TTN.documentOnReady.carousel_background_below();
            TTN.documentOnReady.carousel_1i_dot_center_number();
            TTN.documentOnReady.ttn_navigation_nav_dots_horizontal();
            TTN.documentOnReady.customCarouselNav();
            TTN.documentOnReady.ttn_scroll_element();
            TTN.documentOnReady.ttn_theme_switch();
            TTN.documentOnReady.ttn_bookmark();
            TTN.documentOnReady.reviewRatingStarIcon();
            TTN.documentOnReady.reviewScoreList();
            TTN.documentOnReady.reviewScoreProgress();
            TTN.documentOnReady.ttn_accordionButton();
            TTN.documentOnReady.textFadeLimit();
        },
        /* ============================================================================
         * Scroll top
         * ==========================================================================*/
        ...
        * ==========================================================================*/
        carousel_1i: function() {
            var $carousels = $('.js-ttn-carousel-1i');
        ...
        carousel_1i30m: function() {
            var $carousels = $('.js-ttn-carousel-1i-30m');
            $carousels.each( function() {
                $(this).owlCarousel({
                    items: 1,
                    margin: 0,
        ...
        carousel_1i30m_no_reponsive: function() {
            var $carousels = $('.js-ttn-carousel-1i-30m-no-responsive');
            $carousels.each( function() {
                $(this).owlCarousel({
                    items: 1,
                    margin: 30,
        ...
        carousel_1i0m: function() {
            var $carousels = $('.js-ttn-carousel-1i-0m');
            $carousels.each( function() {
                $(this).owlCarousel({
                    items: 1,
                    margin: 0,
        ...
        carousel_1i_get_src: function() {
            var $carousels = $('.js-ttn-carousel-1i-get-src');
            $carousels.each( function() {
        ...
        carousel_1i_get_src_multiple_margin: function() {
            var $carousels = $('.js-ttn-carousel-1i-get-src-multiple-margin');
            $carousels.each( function() {
                var carousel_loop = $(this).data('carousel-loop');
                var carousel_margin = parseInt($(this).data('carousel-margin'));
                $(this).owlCarousel({
        ...
        carousel_1i_get_src_width_auto: function() {
            var $carousels = $('.js-ttn-carousel-1i-get-src-width-auto');
            $carousels.each( function() {
                var carousel_loop = $(this).data('carousel-loop');
                var carousel_margin = parseInt($(this).data('carousel-margin'));
                $(this).owlCarousel({
        ...
        carousel_1i_get_src_width_auto_0m: function() {
            var $carousels = $('.js-ttn-carousel-1i-get-src-width-auto-0m');
            $carousels.each( function() {
                var carousel_loop = $(this).data('carousel-loop');
                var carousel_margin = parseInt($(this).data('carousel-margin'));
                $(this).owlCarousel({
        ...
        carousel_1i_get_src_width_auto_center: function() {
            var $carousels = $('.js-ttn-carousel-1i-get-src-width-auto-center');
            $carousels.each( function() {
                var carousel_loop = $(this).data('carousel-loop');
                var carousel_margin = parseInt($(this).data('carousel-margin'));
                $(this).owlCarousel({
        ...
        carousel_hover_cursor_effect: function() {
            if ( $.isFunction($.fn.owlCarousel) ) {
                var $carousels = $('.js-ttn-carousel-hover-cursor-effect');
                $carousels.each( function() {
                    var element = $(this);
        ...
        carousel_1i40m: function() {
            var $carousels = $('.js-ttn-carousel-1i-40m');
            $carousels.each( function() {
                $(this).owlCarousel({
                    items: 1,
                    margin: 30,
        ...
        carousel_1i_text_fade: function() {
            var $carousels = $('.js-ttn-carousel-1i-text-fade');
            $carousels.each( function() {
                $(this).owlCarousel({
                    items: 1,
                    margin: 0,
        ...
        carousel_1i_dot_number_effect: function() {
            var $carousels = $('.js-ttn-carousel-1i-dot-number-effect');
            $carousels.each( function() {
                var carousel_loop = $(this).data('carousel-loop');
                $(this).owlCarousel({
                    items: 1,
        ...
        carousel_2i30m: function() {
            var $carousels = $('.js-ttn-carousel-2i-30m');
            $carousels.each( function() {
                $(this).owlCarousel({
                    items: 2,
                    margin: 30,
        ...
        carousel_4i0m: function() {
            var $carousels = $('.js-ttn-carousel-4i-0m');
            $carousels.each( function() {
                var carousel_loop = $(this).data('carousel-loop');
                $(this).owlCarousel({
                    items: 4,
        ...
        carousel_auto_width: function() {
            var $carousels = $('.js-ttn-carousel-auto-width');
            $carousels.each( function() {
                var carousel_loop = $(this).data('carousel-loop');
                var carousel_margin = parseInt($(this).data('carousel-margin'));
                $(this).owlCarousel({
        ...
        carousel_auto_width_rtl: function() {
            var $carousels = $('.js-ttn-carousel-auto-width-rtl');
            $carousels.each( function() {
                var carousel_loop = $(this).data('carousel-loop');
                var carousel_margin = parseInt($(this).data('carousel-margin'));
                $(this).owlCarousel({
        ...
        carousel_auto_width_delay: function() {
            var $carousels = $('.js-ttn-carousel-auto-width-delay');
            $carousels.each( function() {
                var carousel_loop = $(this).data('carousel-loop');
                var carousel_margin = parseInt($(this).data('carousel-margin'));
                $(this).owlCarousel({
        ...
        carousel_auto_width_center: function() {
            var $carousels = $('.js-ttn-carousel-auto-width-center');
            $carousels.each( function() {
                var carousel_loop = $(this).data('carousel-loop');
                var carousel_margin = parseInt($(this).data('carousel-margin'));
                $(this).owlCarousel({
        ...
        carousel_background_below: function() {
            var $carousels = $('.js-ttn-carousel-background-below');
            $carousels.each( function() {
                var carousel_loop = $(this).data('carousel-loop');
                var carousel_margin = parseInt($(this).data('carousel-margin'));
                $(this).owlCarousel({
        ...
        carousel_1i_dot_center_number: function() {
            var $carousels = $('.js-ttn-carousel-1i-dot-center-number');
            $carousels.each( function() {
                var $this = $(this);
        ...
        customCarouselNav: function() {
            if ( $.isFunction($.fn.owlCarousel) ) {
                ...
                $carouselNexts.each( function() {
                    ...
                    var carouselID = carouselNext.parent('.ttn-carousel-nav-custom-holder').attr('data-carouselID');
                ...
                $carouselPrevs.each( function() {
                    ...
                    var carouselID = carouselPrev.parent('.ttn-carousel-nav-custom-holder').attr('data-carouselID');
                    var $carousel = $('#' + carouselID);
        ...
        ttn_navigation_nav_dots_horizontal: function () {
        ...
        * Review Rating
        * ==========================================================================*/
        ttn_accordionButton :function() {
            var accordion = $('.ttn-accordion');
            $(accordion).each(function () {
                var item_current = $(this);
                $(this).find('.ttn-accordion-btn').on('click',function () {
                    var accordion_btn =  $(this).toggleClass('active');
                    var accordion_panel = accordion_btn.parents('.ttn-accordion').find('.ttn-accordion-panel');
                ...
                $(window).on('resize', $.debounce(250, function (e) {
                    var accordion_panel = item_current.find('.ttn-accordion-panel');
        ...
        * ==========================================================================*/
        reviewRatingStarIcon: function() {
            var reviews_rating_star = $('.ttn-reviews-section');
        ...
        reviewScoreList: function(){
            var reviews_rating_score = $('.ttn-reviews-section');
        ...
        * ==========================================================================*/
        ttn_theme_switch: function () {
            var theme_penal_localStorage = [];
            var theme_mode = $('.ttn-theme-switch');
            ...
            theme_mode.each(function () {
                ...
                function saveStatus() {
                    if (window.localStorage) {
                        ...
                        $(theme_penal).toggleClass('ttn-dark-mode');
                    }
                }
            });
            function load_data() {
                ...
                if (status["Status"] == 'true') {
                    $(theme_penal).addClass('ttn-dark-mode');
    ...
    TTN.documentOnLoad = {
        ...
        init: function() {
            TTN.header.smartAffix.compute(); //recompute when all the page + logos are loaded
            TTN.header.smartAffix.updateState(); // update state
            TTN.documentOnReady.stickySidebar();
        }
    ...
    $document.ready( TTN.documentOnReady.init );
    $window.on('load', TTN.documentOnLoad.init );
    $window.on( 'resize', TTN.documentOnResize.init );
